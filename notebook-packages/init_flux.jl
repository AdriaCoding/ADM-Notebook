...
# ╔═╡ 1fa360da-0895-11ef-0bae-f741160aebf9
md"# Flux - Getting started"

# ╔═╡ cdee1814-f13d-49c0-8c98-1a61776f17d4
md"## 1. Flux Overview - Fitting a Straight line
[reference](https://fluxml.ai/Flux.jl/stable/models/overview/#man-overview)

Some notes:
- Under the hood, Flux uses a technique called automatic differentiation to take gradients that help improve predictions"

# ╔═╡ 40bcc1b0-d12b-4f0c-a730-446066ba2e1d
actual(x) = 4x+ 2

# ╔═╡ 3649e493-ad6b-46f6-b692-af94692cb8c3
...
# ╔═╡ deb6b680-ed19-4b33-97a9-3c7a66606633
model.weight

# ╔═╡ b21d6aab-180c-4a49-9daa-8c81cbbd18d2
model.bias

# ╔═╡ beae2857-a52c-440e-ad08-ef3190a3ea70
predict = Dense(1 => 1)

# ╔═╡ 8227a03b-7592-4dc0-8fbd-dfbf3ca9700c
predict(x_train)
...
# ╔═╡ 2c5b6174-90dc-4b60-ba9a-63eb7e9c7729
predict(x_test)
...
[reference](https://fluxml.ai/Flux.jl/stable/models/basics/)"


# ╔═╡ 54c67765-f3ea-41e5-a58d-b096c944ff6c
begin
...
# ╔═╡ 76afc11b-42e1-4e44-8564-2cffd1cf0f49
b

# ╔═╡ d2fa5de8-f031-4b2e-a8f9-7bfb91a7eec9
...
# ╔═╡ 39095a80-3966-486d-af97-17c959ea2fdf
md"Summary:
- The loss function is evaluated with the current values of x, y, W, and b.
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "7a495e7463dfdd0657a6e00b396f23ea308a3312"
